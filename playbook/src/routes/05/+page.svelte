...
<p>
	...
	Per node: AMD EPYC 7402P, 24 cores at 2.80 GHz; 128 GB ECC DDR3-3200; two 1.6 TB PCIe 4.0 NVMe SSDs; ConnectX-5 Ex 100 GbE, one port on the experiment network.<br />
...
<div class="table-scroll">
	<table class="spec">
		...
		<tbody>
			...
			<tr><td class="k">8–9</td><td>Protocol, rendezvous placement, k, PUT with durable ack, HAS, single-pass garbage collection. Provisioning and migration scripts.</td><td>Replicated mode on two nodes.</td></tr>
